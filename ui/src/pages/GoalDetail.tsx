...
export function GoalPropertiesToggleButton({
  ...
  return (
    <Button
      ...
      title={t("ui.goalDetail.showProperties")}
    >
...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("ui.breadcrumb.goals"), href: "/goals" },
      { label: goal?.title ?? goalId ?? t("ui.breadcrumb.goal") }
    ]);
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <InlineEditor
          ...
          placeholder={t("ui.goalDetail.addDescription")}
          multiline
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            {t("ui.goalDetail.subGoals")} ({childGoals.length})
          </TabsTrigger>
          <TabsTrigger value="projects">
            {t("ui.goalDetail.projects")} ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          <div className="flex items-center justify-start">
            ...
            >
              ...
              {t("ui.goalDetail.subGoal")}
            </Button>
          </div>
          {childGoals.length === 0 ? (
            <p className="text-sm text-muted-foreground">{t("ui.goalDetail.noSubGoals")}</p>
          ) : (
        ...
        <TabsContent value="projects" className="mt-4">
          {linkedProjects.length === 0 ? (
            <p className="text-sm text-muted-foreground">{t("ui.goalDetail.noLinkedProjects")}</p>
          ) : (
