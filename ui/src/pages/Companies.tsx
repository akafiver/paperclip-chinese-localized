...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("ui.breadcrumb.companies") }]);
  }, [setBreadcrumbs, t]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-end">
        <Button size="sm" onClick={() => openOnboarding()}>
          ...
          {t("ui.companies.newCompany")}
        </Button>
      </div>

      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("ui.companies.loadingCompanies")}</p>}
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {agentCount} {agentCount === 1 ? t("ui.companies.agents") : t("ui.companies.agentsCount")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {issueCount} {issueCount === 1 ? t("ui.companies.task") : t("ui.companies.tasksCount")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("ui.companies.unlimitedBudget")}</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>{t("ui.companies.created")} {relativeTime(company.createdAt)}</span>
                </div>
              </div>
