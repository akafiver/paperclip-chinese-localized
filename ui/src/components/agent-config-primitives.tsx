...
export const help: Record<string, string> = {
  ...
  cwd: "Optional absolute working-directory override for local adapters. When empty, every agent uses the Paperclip-resolved project workspace; the Paperclip source tree is always rejected.",
