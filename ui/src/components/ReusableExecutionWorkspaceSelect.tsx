...
export function ReusableExecutionWorkspaceSelect<TWorkspace extends ReusableExecutionWorkspaceLike>({
  ...
  return (
    <SearchableSelect<string, ReusableWorkspaceOption<TWorkspace>>
      ...
      placeholder={placeholder ?? t("ui.reusableExecutionWorkspace.chooseExisting")}
      searchPlaceholder={t("ui.reusableExecutionWorkspace.search")}
      emptyMessage={error ? t("ui.reusableExecutionWorkspace.failedLoad") : t("ui.reusableExecutionWorkspace.noMatches")}
      loadingMessage={t("ui.reusableExecutionWorkspace.loading")}
      loading={loading}
      disabled={disabled}
      className={className}
