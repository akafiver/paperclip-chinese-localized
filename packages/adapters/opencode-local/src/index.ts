...
Core fields:
- cwd (string, optional): explicit absolute agent working directory override; when omitted, Paperclip uses the resolved project workspace
...
- Runs are executed with: opencode run --format json --dir <resolved-workspace> ...
